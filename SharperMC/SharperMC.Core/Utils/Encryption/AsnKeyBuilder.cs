...
namespace SharperMC.Core.Utils.Encryption
{
    /// <summary>
    ...
    public class AsnKeyBuilder
    {
        ...
        public static RSA DecodePublicKey(byte[] publicKeyBytes)
        {
            ...
            try
            {
                ...
                switch (shortValue)
                {
                    ...
                    case 0x8230:
                        ...
                        break;
                    default:
                        Console.WriteLine("PublicKey Decode Returning null!");
                        return null;
                }
                ...
                {
                    Console.WriteLine($"PublicKey Decode Returning null! (shortvalue 1)");
                    return null;
                }
                ...
                if (byteValue != 0x00)
                {
                    Console.WriteLine($"PublicKey Decode Returning null! (bytevalue)");
                    return null;
                }
                ...
                {
                    Console.WriteLine($"PublicKey Decode Returning null! (Shortvalue 2)");
                    return null;
                }
            ...
            {
                Console.WriteLine($"PublicKey Decode Exception: {e}");
                return null;
            }
            finally
            {
