...
namespace SharperMC.Core.Structures
{
    public class Structure
    {
		...
		public virtual void Create(Chunk chunk, int x, int y, int z)
		{
			if (chunk.GetBlock(x, y + Height, z) == 0)
			{
				...
				{
					chunk.SetBlock(x + (int) b.Location.X, y + (int) b.Location.Y, z + (int) b.Location.Z, b);
				}
			}
		}

		protected void GenerateVanillaLeaves(Chunk chunk, Vector3 location, int radius, Block block)
		{
